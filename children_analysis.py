...
def create_stunting_ch(df, country, year):
    ...
    var_stunting_z = config_data[country][year]["stunting_ch"]["col_names"][1]

    # :: VALUES
    stunting_flag_values = config_data[country][year]["stunting_ch"]["values"][0]
...
def create_wasting_ch(df, country, year):
    ...
    # :: COL_NAMES
    var_wasting_flag = config_data[country][year]["wasting_ch"]["col_names"][0]
    var_wasting_z = config_data[country][year]["wasting_ch"]["col_names"][1]

    # :: VALUES
    wasting_flag_values = config_data[country][year]["wasting_ch"]["values"][0]
...
def create_overweight_ch(df, country, year):
    ...
    # :: COL_NAMES
    var_overweight_flag = config_data[country][year]["overweight_ch"]["col_names"][0]
    var_overweight_z = config_data[country][year]["overweight_ch"]["col_names"][1]

    # :: VALUES
    overweight_flag_values = config_data[country][year]["overweight_ch"]["values"][0]
